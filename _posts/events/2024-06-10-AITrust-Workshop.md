...
| Quick links |
|--|
|[Program](#program) <br> [Invited speakers](#invited-speakers) <br> - Krister Lindén, Finland <br> - Virginia Dignum, Sweden <br> [Call for papers](#call-for-papers) <br> [Submission information](#submission-information) <br> [Important dates](#important-dates) <br> [Program committee](#program-committee) <br> [Organizers](#organizers)|
...
|--|
|**NLP is Dead - Now What?** <br> Many corpora are publicly accessible, but the FAIR principles do not require every corpus to be openly available as long as there is an openly known path to access it. This allows for other ways to protect data sets than anonymisation or pseudonymisation, e.g. using password protected log-in and encryption.
